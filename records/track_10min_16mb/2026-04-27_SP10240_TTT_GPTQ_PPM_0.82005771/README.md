...
### Previous Submission (TTT + GPTQ, no PPM) — PR #1707
| Seed | BPB |
|------|-----|
| 123 | 1.07044 |
| 999 | 1.07061 |
...
### This Submission (TTT + GPTQ + PPM-D Mixture)
| Seed | Neural TTT BPB | PPM Mix BPB |
|------|---------------|-------------|
| 123 | 1.07045017 | 0.81998601 |
| 999 | 1.07061850 | 0.81999601 |
| 42  | 1.07094129 | 0.82019110 |
| **Mean** | **1.07067** | **0.82005771** |

**Improvement over previous submission: −0.25063 BPB**
...
- **Statistical significance:** Mean improvement of 0.25063 BPB over previous submission
